...
int main() {
  ...
  while (tc--) {
    i64 n;
    cin >> n;
    vec<vec<bool>> m1(n, vec<bool>(n, false));
    vec<vec<bool>> m2(n, vec<bool>(n, false));
    vec<vec<bool>> m3(n, vec<bool>(n, false));
    vec<vec<bool>> m4(n, vec<bool>(n, false));
    ...
    for (i64 i = 0; i < n; i++) {
      for (i64 j = 0; j < n; j++) {
        if (t1[i][j] == false && m2[i][j] == true) {
          res1++;
          t1[i][j] = true;
        }
        if (t2[i][j] == true && m2[i][j] == false) {
          res2++;
          t2[i][j] = false;
        }
      }
    ...
    for (i64 i = 0; i < n; i++) {
      for (i64 j = 0; j < n; j++) {
        if (t1[i][j] == false && m3[i][j] == true) {
          res1++;
          t1[i][j] = true;
        }
        if (t2[i][j] == true && m3[i][j] == false) {
          res2++;
          t2[i][j] = false;
        }
      }
    ...
    for (i64 i = 0; i < n; i++) {
      for (i64 j = 0; j < n; j++) {
        if (t1[i][j] == false && m4[i][j] == true) {
          res1++;
          t1[i][j] = true;
        }
        if (t2[i][j] == true && m4[i][j] == false) {
          res2++;
          t2[i][j] = false;
        }
      }
